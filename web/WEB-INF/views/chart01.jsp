            ...
            <DIV id="divPointError" style="DISPLAY: none; FLOAT: left; MARGIN: 0px 0px 10px">
                <DIV class="pointErrorMsg">您目前的积分为：<SPAN id="myPointNumber">0</SPAN>分，本次购物需支付：<SPAN
                        id="needPointNumber">0</SPAN>分，请修改购物车中的积分换购产品。</DIV><IMG id="imgPointError"
                                                                                 src="${ctx}/images/jifenbuzhu.gif" useMap=#Map border=0> <MAP id="Map"
                ...
                <td align="left" valign="top" height="145"><div class="changeAdd" align="center">
                    <ul class="ulSty">
                        <li>收  货  人：刘德华<br />
                            ...
                            固定电话：<br />
                            移动电话：138********<br />
                            <span class="addDeleteSty addFontCol"><a href="#"><span class="addFontCol">修改</span></a><span class="addFontCol">　|</span>　<a href="#"><span class="addFontCol">删除</span></a></span><span class="addSpanSty"><a href="chart02.html"><img src="${ctx}/images/button_pszADd.gif" border="0" onclick="#" /></a></span></li>
                        <li class="liSty"></li>
                    </ul>
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <ul class="psAdd" align="left">
                                            ...
                                            <li class="conLi7"><span class="addSpanSty"><a href="chart02.html"><img src="${ctx}/images/button_pszADd.gif" alt="" border="0" onclick="#" /></a></span></li>
                                        </ul></td>
                                </tr>
