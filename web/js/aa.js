...
var KISSY = function (a) {
    ...
    var g, l = 0, k = {debug: 10, info: 20, warn: 30, error: 40};
    g = {__BUILD_TIME: "20131121234724", Env: {host: this}, Config: {debug: "", fns: {}}, version: "1.40", config: function (d, e) {
        var n, b, c = this, p, h = g.Config, q = h.fns;
    ...
    g.Logger.Level = {DEBUG: "debug", INFO: "info", WARN: "warn", ERROR: "error"};
    return g
}();
(function (a, e) {
    function g() {
    ...
    function l(c, j, b, m, i, h) {
        ...
        for (p = 0; p < g; p++)if (t = f[p], t != d) {
            var k = c, x = j, E = b, F = m, H = i, L = h;
            if (E || !(t in k) || H) {
                var w = k[t], u = x[t];
                if (w === u)w === e && (k[t] = w); else if (F && (u = F.call(x, t, u)), H && u && (a.isArray(u) || a.isPlainObject(u)))u[d] ? k[t] = u[d] : (x = w && (a.isArray(w) || a.isPlainObject(w)) ? w : a.isArray(u) ? [] : {}, k[t] = x, l(x, u, E, F, n, L)); else if (u !== e && (E || !(t in k)))k[t] = u
            }
        }
        return c
    }
    ...
    var d = "__MIX_CIRCULAR", f = this, n = !0, b = Object, c = b.create, p = !{toString: 1}.propertyIsEnumerable("toString"), h = "constructor,hasOwnProperty,isPrototypeOf,propertyIsEnumerable,toString,toLocaleString,valueOf".split(",");
    (function (a, c) {
        for (var b in c)a[b] = c[b]
    })(a, {stamp: function (c, b, o) {
        var o = o || "__~ks_stamped", m = c[o];
        if (!m && !b)try {
            m = c[o] = a.guid(o)
        } catch (i) {
            m = e
        ...
        if (p)for (m = h.length - 1; 0 <= m; m--)b = h[m], a.hasOwnProperty(b) &&
            c.push(b);
        return c
    }, mix: function (c, b, o, m, i) {
        "object" === typeof o && (m = o.whitelist, i = o.deep, o = o.overwrite);
        if (m && "function" !== typeof m)var h = m, m = function (c, b) {
        ...
        var c = a.makeArray(arguments), b = {}, o, m = c.length;
        for (o = 0; o < m; o++)a.mix(b, c[o]);
        return b
    }, augment: function (c, b) {
        var o = a.makeArray(arguments), m = o.length - 2, i = 1, h, d, p = o[m], f = o[m + 1];
        ...
        var c = a.makeArray(arguments), b = c.length, o = null, m, i, h, d = c[b - 1] === n && b--;
        for (m = 0; m < b; m++) {
            h = ("" + c[m]).split(".");
            o = d ? f : this;
...
(function (a, e) {
    var g = Array.prototype, l = g.indexOf, k = g.lastIndexOf, d = g.filter, f = g.every, n = g.some, b = g.map;
    a.mix(a, {each: function (c, b, h) {
        if (c) {
            var d, j, o = 0;
            d = c && c.length;
            j = d === e || "function" == a.type(c);
            h = h || null;
            if (j)for (j = a.keys(c); o < j.length && !(d = j[o], !1 === b.call(h, c[d], d, c)); o++); else for (j = c[0]; o < d && !1 !== b.call(h, j, o, c); j = c[++o]);
        }
        return c
    }, indexOf: l ? function (a, b) {
        return l.call(b, a)
    } : function (a, b) {
        for (var h = 0, d = b.length; h < d; ++h)if (b[h] === a)return h;
        return-1
        ...
        var j = 0, o;
        if (3 <= arguments.length)o = arguments[2]; else {
            do {
                if (j in a) {
                    o = a[j++];
                    break
        ...
        return o
    }, every: f ? function (a, b, d) {
        return f.call(a, b, d || this)
    } : function (a, b, d) {
        for (var q = a && a.length || 0, j = 0; j < q; j++)if (j in a && !b.call(d, a[j], j, a))return!1;
        return!0
    }, some: n ? function (a, b, d) {
        return n.call(a, b, d || this)
    } : function (a, b, d) {
        for (var q = a && a.length || 0, j = 0; j < q; j++)if (j in a && b.call(d, a[j], j, a))return!0;
        return!1
    }, makeArray: function (b) {
        if (null == b)return[];
        if (a.isArray(b))return b;
        var d = typeof b.length, h = typeof b;
...
(function (a, e) {
    ...
    a.mix(a, {urlEncode: function (a) {
        ...
        var m = [], i, r, f, p, k, n =
            a.urlEncode;
        for (i in b)if (k = b[i], i = n(i), g(k))m.push(i), k !== e && m.push(j, n(k + d)), m.push(c); else if (a.isArray(k) && k.length) {
            r = 0;
...
(function (a) {
    function e(a, e, k) {
        var d = [].slice, f = d.call(arguments, 3), n = function () {
        }, b = function () {
    ...
    }, bind: e(0, e, null, 0), rbind: e(0, e, null, 1), later: function (e, l, k, d, f) {
        var l = l || 0, n = e, b = a.makeArray(f), c;
...
(function (a, e) {
    function g(b, c, e) {
        ...
        if ("object" === typeof b) {
            m = b.constructor;
            if (a.inArray(m, [Boolean, String, Number, Date, RegExp]))h = new m(b.valueOf()); else if (q = a.isArray(b))h = c ? a.filter(b, c) : b.concat(); else if (j = a.isPlainObject(b))h = {};
            b[f] = m = a.guid("c");
            e[m] = {destination: h, input: b}
        }
        if (q)for (b = 0; b < h.length; b++)h[b] = g(h[b], c, e); else if (j)for (o in b)if (o !== f && (!c || c.call(b, b[o], o, b) !== d))h[o] = g(b[o], c, e);
        return h
    }
    ...
    var k = !0, d = !1, f = "__~ks_cloned", n = "__~ks_compared";
    a.mix(a, {equals: function (a, c, d, h) {
        d = d || [];
        h = h || [];
...
(function (a, e) {
    var g = /^[\s\xa0]+|[\s\xa0]+$/g, l = String.prototype.trim, k = /\\?\{([^{}]+)\}/g;
    a.mix(a, {trim: l ? function (a) {
...
(function (a, e) {
    var g = {}, l = Object.prototype, k = l.toString;
    a.mix(a, {type: function (a) {
...
(function (a) {
    ...
    var g = /^(\/?)([\s\S]+\/(?!$)|\/)?((?:\.{1,2}$|[\s\S]+?)?(\.[^.\/]*)?)$/, l = a.Path = {resolve: function () {
        var k = "", d, f = arguments, g, b = 0;
        ...
        var d =
            "/" == k.charAt(0), f = "/" == k.slice(-1), k = e(a.filter(k.split("/"), function (a) {
            return!!a
        }), !d).join("/");
        !k && !d && (k = ".");
        k && f && (k += "/");
        ...
        var e = l.normalize(e), d = l.normalize(d), f = a.filter(e.split("/"), function (a) {
            return!!a
        }), g = [], b, c, p = a.filter(d.split("/"), function (a) {
            return!!a
        });
...
(function (a, e) {
    ...
    function d(b) {
        ...
        var c = this;
        a.mix(c, {scheme: "", userInfo: "", hostname: "", port: "", path: "", query: "", fragment: ""});
        b = d.getComponents(b);
        a.each(b, function (b, d) {
            b = b || "";
            if ("query" == d)c.query = new l(b); else {
                try {
                    b = a.urlDecode(b)
                } catch (j) {
                    j + "urlDecode error : " +
    ...
    var f = /[#\/\?@]/g, n = /[#\?]/g, b = /[#@]/g, c = /#/g, p = RegExp("^(?:([\\w\\d+.-]+):)?(?://(?:([^/?#@]*)@)?([\\w\\d\\-\\u0100-\\uffff.+%]*|\\[[^\\]]+\\])(?::([0-9]+))?)?([^?#]+)?(?:\\?([^#]*))?(?:#(.*))?$"), h = a.Path, q = {scheme: 1, userInfo: 2, hostname: 3, port: 4, path: 5, query: 6, fragment: 7};
    l.prototype = {constructor: l, clone: function () {
        ...
        var c,
            d;
        if ("string" == typeof a)g(this), c = this._queryMap, d = c[a], d = d === e ? b : [].concat(d).concat(b), c[a] = d; else for (c in a instanceof l && (a = a.get()), a)this.add(c, a[c]);
        return this
    }, toString: function (b) {
        g(this);
        return a.param(this._queryMap, e, e, b)
    }};
    d.prototype = {constructor: d, clone: function () {
        var b = new d, c = this;
        ...
        var c = 0, m, i = this.clone();
        a.each("scheme,userInfo,hostname,port,path,query,fragment".split(","),
            function (d) {
                if (d == "path")if (c)i[d] = b[d]; else {
                    if (d = b.path) {
                        c = 1;
                        if (!a.startsWith(d, "/"))if (i.hostname && !i.path)d = "/" + d; else if (i.path) {
...
(function (a, e) {
    ...
    function d(a) {
        var b, c = "", d = "", i, h = [6, 9], f, p = n && n.createElement("div"), D = [], s = {webkit: e, trident: e, gecko: e, presto: e, chrome: e, safari: e, firefox: e, ie: e, opera: e, mobile: e, core: e,
            shell: e, phantomjs: e, os: e, ipad: e, iphone: e, ipod: e, ios: e, android: e, nodejs: e};
        ...
        if (0 < D.length) {
            ...
            if ((i = a.match(/OPR\/(\d+\.\d+)/)) &&
                i[1])s[d = "opera"] = g(i[1]); else if ((i = a.match(/Chrome\/([\d.]*)/)) && i[1])s[d = "chrome"] = g(i[1]); else if ((i = a.match(/\/([\d.]*) Safari/)) && i[1])s[d = "safari"] = g(i[1]);
            ...
            if (s[c = "presto"] = g(i[1]), (i = a.match(/Opera\/([\d.]*)/)) && i[1]) {
                ...
                if ((i = a.match(/Opera Mini[^;]*/)) && i)s.mobile = i[0].toLowerCase(); else if ((i = a.match(/Opera Mobi[^;]*/)) && i)s.mobile = i[0]
            }
        } else if (f = k(a))s[d = "ie"] = f, l(a, s); else if (i =
            a.match(/Gecko/)) {
            s[c = "gecko"] = 0.1;
    ...
    var f = a.Env.host, n = f.document, f = f.navigator, b = KISSY.UA = d(f && f.userAgent || "");
...
(function (a, e) {
    var g = a.Env.host, l = a.UA, k = ["", "Webkit", "Moz", "O", "ms"], d = g.document || {}, f, n, b, c, p, h = d.documentElement, q, j = !0, o = !1, m = "ontouchstart"in d && !l.phantomjs, i = d.documentMode || l.ie;
    h && (h.querySelector && 8 != i && (o = !0), q = h.style, a.each(k, function (a) {
        var d = a ? a + "Transition" : "transition", i = a ? a + "Transform" : "transform";
        c === e && d in q && (c = a, n = d);
        p === e && i in q && (p = a, b = i)
    }), j = "classList"in h, f = "msPointerEnabled"in(g.navigator || {}));
    a.Features = {isMsPointerSupported: function () {
        return f
...
(function (a) {
    ...
    function l(b, c) {
        var d = c.indexOf("!");
        if (-1 != d) {
            var e = c.substring(0, d), c = c.substring(d + 1);
            a.use(e, {sync: !0, success: function (a, d) {
    ...
    var k = a.Loader, d = a.Path, f = a.Env.host, n = a.startsWith, b = k.Status, c = b.ATTACHED, p = b.LOADED, h = b.ERROR, q = k.Utils = {}, j = f.document;
    a.mix(q, {docHead: function () {
        ...
        var c = g(c), e = b.Env.mods, h = e[c];
        return h ? h : e[c] = h = new k.Module(a.mix({name: c, runtime: b}, d))
    }, isAttached: function (b, d) {
        var e;
        a:{
            var h = b.Env.mods, f, g;
            e = a.makeArray(d);
        ...
        var c = c || [], e = e || {}, h, f = 1, g = a.length, p = c.length;
        ...
        var c = g(c), h = b.Env.mods,
            f = h[c];
        f && f.fn ? (c + " is defined more than once", "warn") : (q.createModuleInfo(b, c), f = h[c], a.mix(f, {name: c, status: p, fn: d}), a.mix(f, e))
...
(function (a) {
    ...
    var k = a.Loader, d = a.Path, f = k.Utils;
    a.augment(g, {reset: function (b) {
        a.mix(this, b)
    }, getTag: function () {
        return e(this, "tag")
    }, getName: function () {
    ...
    a.augment(l, {wait: function (a) {
        ...
        getName: function () {
            ...
            var a, c = this.normalizedRequiresStatus, d = this.status, e = this.requires;
    ...
    k.Module = l;
    var n = new g({name: "", runtime: a})
})(KISSY);
(function (a) {
    function e(a, c) {
        var d = 0;
        if (k.webkit)a.sheet && ("webkit css poll loaded: " + c, d = 1); else if (a.sheet)try {
...
(function (a) {
    var e = a.Env.host.document, g = a.Loader.Utils, l = a.Path, k = {}, d, f = a.UA;
    a.getScript = function (n, b, c) {
        ...
        var A = function (b) {
            ...
            delete k[n]
        }, b = "onload"in r, c = a.Config.forceCssPoll || f.webkit && 536 > f.webkit;
        q && c && b && (b = !1);
...
(function (a, e) {
    ...
    var l = a.Loader, k = l.Utils, d = a.Env.host.location, f, n, b = a.Config.fns;
    ...
    b.packages = function (b) {
        var d, f = this.Config, k = f.packages = f.packages || {};
...
(function (a, e) {
    function g(c, f, h, g, j) {
        var k = f && f.length, l = [], o = [];
        a.each(f, function (f) {
            var n, p = {timeout: j, success: function () {
                o.push(f);
            ...
            f.combine || (n = f.mods[0], "css" == n.getType() ? n = e : d && (i = n.name, r = a.now(), p.attrs = {"data-mod-name": n.name}));
            a.Config.loadModsFn(f, p)
        })
    }

    function l(b, d) {
        a.mix(this, {runtime: b, waitingModules: d})
    }
    ...
    var d = a.UA.ie && 10 > a.UA.ie, f = a.Loader, n = f.Status, b = f.Utils, c = b.getHash, p = n.LOADING, h = n.LOADED, q = n.ERROR, j = a.now(), o = n.ATTACHED;
    l.groupTag = j;
    var m, i, r;
    l.add = function (c, f, h, g) {
        if ("function" === typeof c)if (h = f, f = c, d) {
            var c = a.Env.host.document.getElementsByTagName("script"), j, k, l;
            ...
            i = null;
            r = 0
        } else m = {fn: f, config: h}; else d ? (i = null, r = 0) : m = e, b.registerModule(g, c, f, h)
    };
    a.augment(l, {use: function (c) {
        var d = a.Config.timeout, e = this.runtime, c = a.keys(this.calculate(c));
        ...
        var e, f, g, j, i = this.waitingModules, k = this.runtime, d = d || {}, c = c || {};
        ...
        var d = this.runtime, e = d.Config, f = e.comboPrefix, h = e.comboSep, g = e.comboMaxFileNum, j = e.comboMaxUrlLength, i = {}, a = this.getComboMods(a, i), k = {}, l;
        for (l in a) {
            k[l] =
            {};
            for (var n in a[l]) {
                var m = [], o = [], p = a[l][n], q = p.tags, r = (q = 1 < q.length ? c(q.join("")) : q[0]) ? "?t=" + encodeURIComponent(q) + "." + l : "", q = r.length, v = i[n].toString(), M = v.length, J = v + f, y = k[l][n] = [], v = J.length;
                y.charset = p.charset;
                y.mods = [];
                for (var K = function () {
                    y.push({combine: 1, fullpath: b.getMappedPath(d, J + m.join(h) + r, e.mappedComboRules), mods: o})
                }, B = 0; B < p.length; B++) {
                    var z = p[B];
                    y.mods.push(z);
                    var C = z.getFullPath();
                    ...
                    } else y.push({combine: 0, fullpath: C, mods: [z]})
                }
                m.length && K()
            }
        }
...
(function (a, e) {
    ...
    var l = a.Loader, k = a.Env, d = l.Utils, f = a.setImmediate, n = l.ComboLoader;
    g.prototype = {constructor: g, notifyAll: function () {
        var b = this.fn;
    ...
    a.mix(a, {add: function (b, c, d) {
        ...
        b = d.unalias(a, d.normalizeModNamesWithAlias(a,
            [b]));
...
(function (a) {
    function e(b) {
        ...
        var b = (b = b.getAttribute("data-config")) ? (new Function("return " + b))() : {}, e = b.comboPrefix = b.comboPrefix || "??", g = b.comboSep = b.comboSep || ",", l, j = c.indexOf(e);
        -1 == j ? l = c.replace(f, "$1") : (l = c.substring(0, j), "/" != l.charAt(l.length - 1) && (l += "/"), e = c.substring(j + e.length).split(g), a.each(e, function (a) {
            if (a.match(n))return l += a.replace(f, "$1"), !1
        }));
        return a.mix({base: l, tag: k.getHash(d + c)}, b)
    }
    ...
    var l = a.Env.host && a.Env.host.document, k = a.Loader.Utils, d = "20131121234724", f = /^(.*)(seed|kissy)(?:-min)?\.js[^/]*/i, n = /(seed|kissy)(?:-min)?\.js/i;
    a.config({charset: "utf-8", lang: "zh-cn", tag: d});
    a.UA.nodejs ? a.config({charset: "utf-8", base: __dirname.replace(/\\/g, "/").replace(/\/$/, "") + "/"}) : l && l.getElementsByTagName && a.config(a.mix({comboMaxUrlLength: 2E3,
        comboMaxFileNum: 40}, g()))
})(KISSY);
KISSY.add("i18n", {alias: function (a, e) {
...
(function (a, e) {
    ...
    var l = a.Env.host, k = a.UA, d = l.document, f = d && d.documentElement, n = l.location, b = 0, c = [], p = /^#?([\w-]+)$/, h = /\S/, q = !(!d || !d.addEventListener), j = "load", o = q ? function (a, b, c) {
    ...
    a.mix(a, {isWindow: function (a) {
        ...
        var b = (b + "").match(p)[1], e = 1, f = a.later(function () {
    ...
    (function () {
        if (!d || "complete" === d.readyState)g(); else if (o(l, j, g), q) {
            var a = function () {
...
(function (a) {
    a.config({modules: {core: {alias: "dom,event,io,anim,base,node,json,ua,cookie".split(",")}, ajax: {alias: ["io"]}, "rich-base": {alias: ["base"]}}});
    if ("undefined" != typeof location) {
        var e = a.startsWith(location.href, "https") ? "https://s.tbcdn.cn/s/kissy/" : "http://a.tbcdn.cn/s/kissy/";
        a.config({packages: {gallery: {base: e}, mobile: {base: e}}})
    }
})(KISSY);
(function (a, e, g) {
    a({anim: {requires: ["dom", "anim/base", "anim/timer", KISSY.Features.isTransitionSupported() ? "anim/transition" : ""]}});
    a({"anim/base": {requires: ["dom", "promise"]}});
    a({"anim/timer": {requires: ["dom", "anim/base"]}});
    a({"anim/transition": {requires: ["dom", "event/dom", "anim/base"]}});
    a({base: {requires: ["event/custom"]}});
    a({button: {requires: ["node", "component/control"]}});
    a({color: {requires: ["base"]}});
    a({combobox: {requires: ["node", "component/control", "menu", "base", "io"]}});
    a({"component/container": {requires: ["component/control",
        "component/manager"]}});
    ...
    a({"component/plugin/drag": {requires: ["base", "dd"]}});
    ...
    a({"date/picker": {requires: ["node",
        "date/gregorian", "i18n!date/picker", "component/control", "date/format"]}});
    a({"date/popup-picker": {requires: ["date/picker", "component/extension/align", "component/extension/shim"]}});
    a({dd: {requires: ["node", "base"]}});
    a({"dd/plugin/constrain": {requires: ["base", "node"]}});
    a({"dd/plugin/proxy": {requires: ["node", "base", "dd"]}});
    a({"dd/plugin/scroll": {requires: ["dd", "base", "node"]}});
    a({"dom/basic": {alias: ["dom/base", e.isIELessThan(9) ? "dom/ie" : "", e.isClassListSupported() ? "" : "dom/class-list"]}, dom: {alias: ["dom/basic",
        !e.isQuerySelectorSupported() ? "dom/selector" : ""]}});
    a({"dom/class-list": {requires: ["dom/base"]}});
    a({"dom/ie": {requires: ["dom/base"]}});
    a({"dom/selector": {requires: ["dom/basic"]}});
    a({editor: {requires: ["node", "html-parser", "component/control", "event"]}});
    a({event: {requires: ["event/dom", "event/custom"]}});
    a({"event/custom": {requires: ["event/base"]}});
    a({"event/dom": {alias: ["event/dom/base", e.isTouchEventSupported() || e.isMsPointerSupported() ? "event/dom/touch" : "", e.isDeviceMotionSupported() ? "event/dom/shake" :
    ...
    a({"filter-menu": {requires: ["menu", "node",
        "component/extension/content-render"]}});
    a({io: {requires: ["dom", "event/custom", "promise", "event"]}});
    a({kison: {requires: ["base"]}});
    a({menu: {requires: "node,component/container,component/extension/delegate-children,component/control,component/extension/content-render,component/extension/align,component/extension/shim".split(",")}});
    a({menubutton: {requires: ["node", "button", "component/extension/content-render", "menu"]}});
    a({mvc: {requires: ["base", "node", "io", "json"]}});
    a({node: {requires: ["dom", "event/dom",
        "anim"]}});
    a({overlay: {requires: ["component/container", "component/extension/shim", "component/extension/align", "node", "component/extension/content-render"]}});
    a({resizable: {requires: ["node", "base", "dd"]}});
    a({"resizable/plugin/proxy": {requires: ["base", "node"]}});
    a({"scroll-view": {alias: [e.isTouchEventSupported() || e.isMsPointerSupported() ? "scroll-view/drag" : "scroll-view/base"]}});
    a({"scroll-view/base": {requires: ["node", "anim", "component/container", "component/extension/content-render"]}});
    a({"scroll-view/drag": {requires: ["scroll-view/base",
        "node", "anim"]}});
    ...
    a({"split-button": {requires: ["component/container", "button", "menubutton"]}});
    a({stylesheet: {requires: ["dom"]}});
    a({swf: {requires: ["dom", "json", "base"]}});
    a({tabs: {requires: ["component/container", "toolbar", "button"]}});
    a({toolbar: {requires: ["component/container", "component/extension/delegate-children",
        "node"]}});
    a({tree: {requires: ["node", "component/container", "component/extension/content-render", "component/extension/delegate-children"]}});
    a({xtemplate: {requires: ["xtemplate/runtime", "xtemplate/compiler"]}});
    a({"xtemplate/compiler": {requires: ["xtemplate/runtime"]}});
    a({"xtemplate/nodejs": {requires: ["xtemplate"]}})
})(function (a) {
...
(function (a) {
    ...
    var e = a.Env.host, g = (e.document || {}).documentMode, l = (a.UA.nodejs && "object" === typeof global ? global : e).JSON;
    g && 9 > g && (l = null);
    if (l)a.add("json", function () {
        ...
        var k = /^[\],:{}\s]*$/, d = /(?:^|:|,)(?:\s*\[)+/g, f = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, n = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g;
